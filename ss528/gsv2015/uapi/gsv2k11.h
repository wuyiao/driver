...
//#define Gsv2k11ResourceSize  (540+(AvEnableDetailTiming*144)+(AvEnableInternalVideoGen*40)+(AvEnableInternalAudioGen*24)+(AvEnableInternalClockGen*24)+(AvEnableCecFeature*72))
#define Gsv2k11ResourceSize  ((2048+(AvEnableDetailTiming*144)+(AvEnableInternalVideoGen*40)+(AvEnableInternalAudioGen*24)+(AvEnableInternalClockGen*24)+(AvEnableCecFeature*72)) * GSV2015_MAX_NUM)
